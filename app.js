...
const reviews = [
  { service: "individual", name: "Оксана", text: "Спасибо тебе за мою новую версию – за мою настоящую версию, которая всегда во мне была, только я боялась быть настоящей. Теперь я умею выставлять границы, умею говорить «нет», умею выбирать себя." },
  { service: "individual", name: "Марина", text: "Ситуації, які я не могла зрозуміти/вирішити роками вирішувались за одну сесію, залишаючи усвідомлення і відчуття, що життя змінюється на краще. Навчилась будувати здорові відносини з собою, з дітьми, з чоловіком і з оточуючими." },
  { service: "individual", name: "Эля", text: "Я потеряла личные границы, самооценка и самоценность упали. Но я попала к Наталье... Она смогла меня развернуть, помогла посмотреть по сторонам, вокруг себя. Выбирать себя, любить себя, ценить себя. Я реально ожила." },
  { service: "individual", name: "Вікторія", text: "З тобою я поступово вчуся обирати себе — не різко, не боляче, а з турботою й повагою. На сесіях завжди багато тепла, прийняття й водночас глибини. З'являється відчуття опори й віри в себе." },
  { service: "individual", name: "Анастасія", text: "Це той рідкий спеціаліст, рядом з яким чувствуешь себя в безопасности, принятой и услышанной по-настоящему. Каждая встреча — это пространство без осуждения, где можно быть собой." },
  { service: "individual", name: "Людмила", text: "За ці до 10 сесій я отримала багато цінних усвідомлень про себе, свої реакції та внутрішні причини того, що зі мною відбувається. Мені було дуже важливо відчувати безпечний, підтримуючий простір." },
  { service: "individual", name: "Клієнтка KVITKA space", text: "Я попала к тебе в очень сложный период моей жизни... Уже через два місяці нашої роботи я стала почувати себе набагато краще. А через рік — з'явились внутрішні опори, я стала впевненіша в собі." },
  { service: "individual", name: "Клієнтка KVITKA space", text: "Я дуже задоволена результатами терапії з Наталією! Я прийшла з запитом покращити якість свого життя, налагодити стосунки з близькими і знайти сили та енергію до життя. Зараз я почуваюсь набагато впевненіше." },
  { service: "individual", name: "Марія", text: "Я від твого листа відчула мурашки по тілу, виступають сльози... Дуже дякую! Ти врятувала мене, і точно врятуєш інших своєю любов'ю до роботи і клієнтів." },
  { service: "individual", name: "Клієнтка KVITKA space", text: "Спасибо тебе огромное, что ты у меня есть! Спасибо тебе огромное за твой труд, душу и сердце! Я безумно тебе благодарна за то, что ты заново по крупицам собираешь меня, я это ощущаю в каждом дне, в каждом моменте!" },
  { service: "individual", name: "Клієнтка KVITKA space", text: "Хотела написать тебе огромное спасибо за твою работу! Спасибо большое за твою вовлечённость и профессионализм. Я научилась прислушиваться к себе, искать опору внутри себя и находить равновесие в этой турбулентности." },
  { service: "individual", name: "Клієнтка KVITKA space", text: "Щиро дякую за проведену роботу та велике поле для роздумів. Сесії допомогли справитись з великою і «основною» частиною проблем, які до цього доволі заважали. Я звільнила неконструктивного внутрішнього критика." },
  { service: "individual", name: "Учасниця групи NUDZ", text: "Мені на сесіях було десь незрозуміло, десь легко, щось я не хотіла сприймати, іноді прагнула щось довести. Але я була чесною на терапії, була собою. З твоєю допомогою я побачила та прийняла себе. Ти чудова психотерапевтка й дивовижна людина." },
  { service: "individual", name: "Учасниця групи NUDZ", text: "Ви дуже допомогли мені передусім у розумінні та прийнятті самої себе. Завдяки вам я розібралася у своєму стані, зрозуміла, чого я хочу та на що заслуговую. А також моя адаптація в Чехії не затягнулася на роки." },
  { service: "group", name: "Учасниця групи «8 Опор Цілісної Жінки»", text: "Від початку участі я помітила значні зміни у своєму житті: навчилася прислухатися до себе, краще розуміти свої потреби та емоції, а також відчула підтримку й розуміння від учасниць нашої групи. Дякую за створення такого місця, де тепло й затишно." },
  { service: "group", name: "Учасниця групи «8 Опор Цілісної Жінки»", text: "Хочу залишити свій відгук і поділитися тим, що для мене означає ця група. Вже після перших зустрічей відчула, що це місце, де можна розслабитися, говорити відкрито й отримати справжню підтримку. Після кожної зустрічі я виходжу ніби легшою." },
  { service: "group", name: "Учасниця групи «8 Опор Цілісної Жінки»", text: "Дякую Наталії, групі «8 Опор Цілісної Жінки» та NUDZ за таку можливість. Це справді важлива робота, що змінює життя людей. Хотілося б, щоб такі групи продовжували працювати й надалі." }
];
